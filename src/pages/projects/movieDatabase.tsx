...
import { MovieDatabase } from '@/const/project'
    ...
    <div className='w-full'>
        <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
            ...
            <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white p-2 z-10'>
                <h2 className='py-2'>{MovieDatabase.title}</h2>
                <h3>{MovieDatabase.technologyMain}</h3>
            </div>
        </div>
            ...
            <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl p-4'>
                <div className='p-2'>
                    ...
                    <div className='grid grid-cols-3 md:grid-cols-1'>
                        {MovieDatabase.technologyAll.map((technology, index) => (
